...
логин/паролю;  
v3.6.4 +добавление доступных данных из provider в Документ User при регистрации через providers;

-исключить username из коллекции User, оставить в credentials то есть при регистрации по
логин/паролю. в Комментариях пользователя отображать как Имя Ф., идентификацию пользователей
проводить по id;  
