...
v3.5.1 +обновление метода регистрации участника в чемпионат из-за изменившейся структур схем
чемпионата и заездов;  
v3.5.2 +обновление метода проверки регистрации участника в чемпионате;  
v3.5.3 +обновление метода получения зарегистрированных райдеров в заезде;  
v3.5.4 +обновление метода аннулирования регистрации в заезде;

-вынести подключение к mongo в одно место. Убрать из всех сервисов и методов;  
-не удаляется последняя категория в блоке категория по уровню подготовки;  
