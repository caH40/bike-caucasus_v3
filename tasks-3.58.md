...
v3.77.13 +исправлен баг при отображении списка чемпионатов; v3.78.1 +обновление nextjs из за
уязвимости CVE-2025-66478. Обновление других зависимостей fix audit;
