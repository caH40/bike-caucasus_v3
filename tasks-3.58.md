...
v3.79.1 +обновлен nextjs до версии; v3.79.2 +переименован middleware to proxy.ts;  
v3.79.3 +исправлен баг с отображением данных в интерактивном блоке карточек;  
v3.79.4 +добавлен компонент спинер загрузки; v3.79.5 +временно удалена возможность
аутентификации через vk;
