...
-при добавлении результата не проверяются стартовые номера на дубликаты;  
-в протоколах для женщин сделать фон стартового номера фиолетовым, то есть отличным от мужского;
