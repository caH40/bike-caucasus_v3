...
v3.77.3 +отображение метаданных при ошибке в логах;  
v3.77.4 +отображение профиля высоты дистанции в заезде согласно количеству кругов;  
v3.77.5 +исправлен баг с бесконечными ререндеренгами при отображении профиля высоты;  
v3.77.6 +мемоизация расчета графика профиля высоты дистанции;  
v3.77.7 +отображение метаданных при ошибке в логах для страницы новость;  
v3.77.8 +отображение метаданных при ошибке в логах для страницы маршрута;  
v3.77.9 +исправление мелкого бага;  
v3.77.10 +отображение метаданных при ошибке в логах для страницы дистанция;  
v3.77.11 +полные данные по дистанции в описании дистанции заезда;  
v3.77.12 +полные данные по дистанции в описании маршрута;  
v3.77.13 +исправлен баг при отображении списка чемпионатов;  
v3.78.1 +обновление nextjs из за уязвимости CVE-2025-66478. Обновление других зависимостей fix
audit;  
v3.78.2 +добавлен env в gitignore;  
v3.79.1 +обновлен nextjs до версии;  
v3.79.2 +переименован middleware to proxy.ts;  
v3.79.3 +исправлен баг с отображением данных в интерактивном блоке карточек;  
v3.79.4 +добавлен компонент спинер загрузки;  
v3.79.5 +временно удалена возможность аутентификации через vk;  
v3.79.6 +добавлен регион абхазия;  
v3.79.7 +bodySizeLimit установлен 50мб; v3.79.8 +тестовый коммит;

-в новость добавить дату актуальности новости, после которой новость не отображать в рассылках и
выставить соответсвующий хэштег в тэгах страницы.  
-в профиле добавить информацию от дистанциях где райдер входит в топ3;  
...
https://www.youtube.com/watch?v=jD6813wGdBA&t=427s; -необходимо более информативно сообщать об
ошибках при заполнении форм-;  
