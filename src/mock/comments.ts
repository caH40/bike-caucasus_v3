...
export const comments: TCommentDto[] = [
  ...
  {
    _id: '2',
    text: 'Было интересно наблюдать за борьбой лидеров до самого конца! Организаторы постарались на славу! В следующем году обязательно приеду снова. Организаторы постарались на славу! В следующем году обязательно приеду снова. Жаль, что не смог принять участие. Но болел за своих друзей!',
    author: {
