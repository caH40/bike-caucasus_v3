...
export default function IconCategory({
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M16.625 10H18.375C20.125 10 21 9.125 21 7.375V5.625C21 3.875 20.125 3 18.375 3H16.625C14.875 3 14 3.875 14 5.625V7.375C14 9.125 14.875 10 16.625 10Z"
          stroke="white"
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
        ...
        />
        <path
          d="M5.625 21H7.375C9.125 21 10 20.125 10 18.375V16.625C10 14.875 9.125 14 7.375 14H5.625C3.875 14 3 14.875 3 16.625V18.375C3 20.125 3.875 21 5.625 21Z"
          stroke="#FFA600"
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
