...
export const protocolColumns: (ColumnDef<TResultRaceDto & { index: number }> & {
  ...
  },
  {
    ...
    cell: (props: any) => <TdGap gap={props.row.original.gapsInCategories?.absolute?.toPrev} />,
    uniqueName: 'Отставания в общем протоколе',
  },
  ...
  },
  {
    ...
    cell: (props: any) => <TdGap gap={props.row.original.gapsInCategories?.category?.toPrev} />,
    uniqueName: 'Отставания в категории',
  },
