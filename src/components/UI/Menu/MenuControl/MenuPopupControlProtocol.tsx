 ...
 */
export default function MenuPopupControlProtocol({ raceInfo: raceInfo }: Props) {
  ...
  const buttons = [
    {
      id: 0,
      name: 'Редактирование',
      href: `/moderation/championship/protocol/${raceInfo.championshipId}/${raceInfo.raceNumber}`,
      permission,
      icon: IconEditOld,
      classes: [],
    },
