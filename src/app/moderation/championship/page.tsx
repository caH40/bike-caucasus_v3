...
export default function ModerationChampionshipPage() {
  return (
    <div className={styles.content}>
      <TitleAndLine
        hSize={1}
        title="Управление и настройка Чемпионатов"
      ...
      <section className={styles.section}>
        ...
        <ol className={styles.list}>
          ...
          <li className={styles.item}>
            <strong>Тип велосипеда</strong>: Выберите тип велосипеда, используемого в чемпионате
            (например, ТТ, горный, шоссейный, даунхильный).
          </li>
      ...
      <section className={styles.section}>
        ...
        <ol className={styles.list}>
          <li className={styles.item}>
            <strong>Обновление информации</strong>: Вы можете изменять все указанные поля, чтобы
            поддерживать информацию о чемпионате актуальной. Если статус чемпионата завершен,
            или отменён, то редактирование данных блокируется.
          </li>
          <li className={styles.item}>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list__ul}>
          ...
          <li className={styles.item}>
            <strong>Поиск и фильтрация</strong>: Используйте инструменты поиска и фильтрации для
            быстрого доступа к конкретным чемпионатам.
          </li>
        </ul>
      </section>
